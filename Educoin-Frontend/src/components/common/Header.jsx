    ...
    <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <div className="flex flex-1 items-center">
          <h1 className="text-lg font-semibold text-gray-900">Bienvenido, {user?.first_name}</h1>
        </div>
        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <Menu as="div" className="relative">
            <Menu.Button className="-m-1.5 flex items-center p-1.5">
              ...
              <div className="h-8 w-8 rounded-full bg-educoin-100 flex items-center justify-center">
                  ...
                  <Menu.Item key={item.name}>
                    {({ active }) => (
                      <Link
                        ...
                        className={`group flex items-center px-3 py-2 text-sm text-gray-700 ${
                          active ? "bg-gray-50" : ""
                        }`}
                      >
                        <item.icon
